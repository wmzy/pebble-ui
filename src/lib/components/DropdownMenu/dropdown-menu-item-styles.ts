...
/**
 * Shared slot and variant skins for the DropdownMenu family's item
 * types (DropdownMenuItem, DropdownMenuCheckboxItem,
 * DropdownMenuRadioItem). Merged after each item's base class so the
 ...
 */
export const dropdownMenuItemDanger = css`
 ...
 */
export const dropdownMenuItemIcon = css`
  display: inline-flex;
  align-items: center;
  flex-shrink: 0;
 ...
 */
export const dropdownMenuItemKbd = css`
 ...
 */
export const dropdownMenuItemIndicator = css`
  display: inline-flex;
  align-items: center;
...
/** Group heading: muted, one step smaller than item text. Shared by DropdownMenuGroup and DropdownMenuRadioGroup's optional label. */
export const dropdownMenuGroupLabel = css`
